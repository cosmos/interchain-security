...
// https://github.com/notional-labs/cosmos-sdk/tree/update-patched-47-ics
replace github.com/cosmos/cosmos-sdk => github.com/notional-labs/cosmos-sdk v0.47.3-ics
