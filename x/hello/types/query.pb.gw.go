...
var (
	...
	pattern_Query_Hello_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 0, 2, 0}, []string{"hello"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Posts_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 0, 2, 1}, []string{"hello", "posts"}, "", runtime.AssumeColonVerbOpt(true)))
)
