...
// NewParams creates new parent parameters with provided arguments
...
// DefaultParams is the default params for the parent module
...
// Validate all ccv-parent module parameters
