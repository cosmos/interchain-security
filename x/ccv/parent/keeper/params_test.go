...
func (suite *KeeperTestSuite) TestParams() {
	...
	params := suite.parentChain.App.(*appProvider.App).ParentKeeper.GetParams(suite.parentChain.GetContext())
	...
	suite.parentChain.App.(*appProvider.App).ParentKeeper.SetParams(suite.parentChain.GetContext(), newParams)
	params = suite.parentChain.App.(*appProvider.App).ParentKeeper.GetParams(suite.parentChain.GetContext())
