...
func TestSetSlashLog(t *testing.T) {
	...
	addrWithDoubleSigns := providertypes.ProviderConsAddressFromCId(*ututil.NewCryptoIdentityFromIntSeed(1))
	addrWithoutDoubleSigns := providertypes.ProviderConsAddressFromCId(*ututil.NewCryptoIdentityFromIntSeed(2))
