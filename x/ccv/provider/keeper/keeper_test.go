...
func TestSetSlashLog(t *testing.T) {
	...
	addrWithDoubleSigns := ututil.NewCryptoIdentityFromIntSeed(1).ProviderConsAddress()
	addrWithoutDoubleSigns := ututil.NewCryptoIdentityFromIntSeed(2).ProviderConsAddress()
