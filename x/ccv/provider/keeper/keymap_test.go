...
func compareForEquality(t *testing.T,
	...
	ckToMemo map[keeper.ConsumerPubKey]ccvtypes.Memo,
	...
	cnt = 0
	km.Store.IterateCkToMemo(func(_ keeper.ConsumerPubKey, _ ccvtypes.Memo) bool {
		cnt += 1
		return false
	})
...
func checkCorrectSerializationAndDeserialization(t *testing.T,
	...
	ckToMemo[keys[11]] = ccvtypes.Memo{
		Ck:    &keys[12],
		Pk:    &keys[13],
		Cca:   []byte(string1),
		Vscid: uint64_1,
