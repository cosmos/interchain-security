...
// ConsumerAdditionProposals holds matured and pending governance proposals on the provider chain to spawn a new chain.
type ConsumerAdditionProposals struct {
	// proposals to be executed on the next block (spawn_time has passed)
	Matured []*ConsumerAdditionProposal `protobuf:"bytes,1,rep,name=matured,proto3" json:"matured,omitempty"`
	// proposals waiting for spawn_time to pass
	Pending []*ConsumerAdditionProposal `protobuf:"bytes,2,rep,name=pending,proto3" json:"pending,omitempty"`
}
...
func (m *ConsumerAdditionProposals) GetMatured() []*ConsumerAdditionProposal {
	if m != nil {
		return m.Matured
	}
	return nil
...
// ConsumerRemovalProposals holds matured and pending governance proposals on the provider chain to remove (and stop) a consumer chain.
type ConsumerRemovalProposals struct {
	// proposals to be executed on the next block (stop_time has passed)
	Matured []*ConsumerRemovalProposal `protobuf:"bytes,1,rep,name=matured,proto3" json:"matured,omitempty"`
	// proposals waiting for stop_time to pass
	Pending []*ConsumerRemovalProposal `protobuf:"bytes,2,rep,name=pending,proto3" json:"pending,omitempty"`
}
...
func (m *ConsumerRemovalProposals) GetMatured() []*ConsumerRemovalProposal {
	if m != nil {
		return m.Matured
	}
	return nil
...
var fileDescriptor_f22ec409a72b7b72 = []byte{
	...
	,
}
...
func (m *ConsumerAdditionProposals) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Matured) > 0 {
		for iNdEx := len(m.Matured) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.Matured[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *ConsumerAdditionProposals) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Matured", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Matured = append(m.Matured, &ConsumerAdditionProposal{})
			if err := m.Matured[len(m.Matured)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
...
func (m *ConsumerRemovalProposals) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Matured = append(m.Matured, &ConsumerRemovalProposal{})
			if err := m.Matured[len(m.Matured)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
