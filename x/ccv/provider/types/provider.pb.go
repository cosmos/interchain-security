...
// CurrentEpochOptedInValidator is used to facilitate epoch-based transitions. It contains relevant info for
// a validator that is opted in, in the curren epoch, on a consumer chain.
type CurrentEpochOptedInValidator struct {
	...
	// The block height the provider chain had when the validator initially opted in. If the validator remains opted in
	// during subsequent epochs, `start_block_height` remains unchanged.
	...
	// The power the validator had when the validator opted in. If the validator remains opted in, `power` gets
	// updated in subsequent epochs.
	Power int64 `protobuf:"varint,3,opt,name=power,proto3" json:"power,omitempty"`
	// The consumer public key the validator had assigned for the consumer chain chain when the validator opted in.
	// If the validator remains opted in, in subsequent epochs `consumer_public_key` gets updated if the consumer public
	// key has been changed.
	ConsumerPublicKey []byte `protobuf:"bytes,4,opt,name=consumer_public_key,json=consumerPublicKey,proto3" json:"consumer_public_key,omitempty"`
}

func (m *CurrentEpochOptedInValidator) Reset()         { *m = CurrentEpochOptedInValidator{} }
func (m *CurrentEpochOptedInValidator) String() string { return proto.CompactTextString(m) }
func (*CurrentEpochOptedInValidator) ProtoMessage()    {}
func (*CurrentEpochOptedInValidator) Descriptor() ([]byte, []int) {
	return fileDescriptor_f22ec409a72b7b72, []int{22}
}
func (m *CurrentEpochOptedInValidator) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CurrentEpochOptedInValidator) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CurrentEpochOptedInValidator.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *CurrentEpochOptedInValidator) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CurrentEpochOptedInValidator.Merge(m, src)
}
func (m *CurrentEpochOptedInValidator) XXX_Size() int {
	return m.Size()
}
func (m *CurrentEpochOptedInValidator) XXX_DiscardUnknown() {
	xxx_messageInfo_CurrentEpochOptedInValidator.DiscardUnknown(m)
}

var xxx_messageInfo_CurrentEpochOptedInValidator proto.InternalMessageInfo

func (m *CurrentEpochOptedInValidator) GetProviderConsAddr() []byte {
	if m != nil {
...
func (m *CurrentEpochOptedInValidator) GetStartBlockHeight() int64 {
	if m != nil {
...
func (m *CurrentEpochOptedInValidator) GetPower() int64 {
	if m != nil {
		return m.Power
	}
	return 0
...
func (m *CurrentEpochOptedInValidator) GetConsumerPublicKey() []byte {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*CurrentEpochOptedInValidator)(nil), "interchain_security.ccv.provider.v1.CurrentEpochOptedInValidator")
}
...
var fileDescriptor_f22ec409a72b7b72 = []byte{
	...
	,
}
...
func (m *CurrentEpochOptedInValidator) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CurrentEpochOptedInValidator) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CurrentEpochOptedInValidator) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.ConsumerPublicKey) > 0 {
		i -= len(m.ConsumerPublicKey)
		copy(dAtA[i:], m.ConsumerPublicKey)
		i = encodeVarintProvider(dAtA, i, uint64(len(m.ConsumerPublicKey)))
		i--
		dAtA[i] = 0x22
	}
	if m.Power != 0 {
	...
	if m.StartBlockHeight != 0 {
		i = encodeVarintProvider(dAtA, i, uint64(m.StartBlockHeight))
		i--
		dAtA[i] = 0x10
	}
...
func (m *CurrentEpochOptedInValidator) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.StartBlockHeight != 0 {
		n += 1 + sovProvider(uint64(m.StartBlockHeight))
	}
	if m.Power != 0 {
		n += 1 + sovProvider(uint64(m.Power))
	}
	l = len(m.ConsumerPublicKey)
	if l > 0 {
		n += 1 + l + sovProvider(uint64(l))
	}
	return n
...
func (m *CurrentEpochOptedInValidator) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CurrentEpochOptedInValidator: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CurrentEpochOptedInValidator: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 4:
			...
			m.ConsumerPublicKey = append(m.ConsumerPublicKey[:0], dAtA[iNdEx:postIndex]...)
			if m.ConsumerPublicKey == nil {
				m.ConsumerPublicKey = []byte{}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
