...
type ConsumerAdditionProposal struct {
	...
	CcvTimeoutPeriod *time.Duration `protobuf:"bytes,10,opt,name=ccv_timeout_period,json=ccvTimeoutPeriod,proto3,stdduration" json:"ccv_timeout_period,omitempty"`
	// Sent transfer related IBC packets will timeout after this duration
	TransferTimeoutPeriod *time.Duration `protobuf:"bytes,11,opt,name=transfer_timeout_period,json=transferTimeoutPeriod,proto3,stdduration" json:"transfer_timeout_period,omitempty"`
	// The fraction of tokens allocated to the consumer redistribution address
	// during distribution events. The fraction is a string representing a
	// decimal number. For example "0.75" would represent 75%.
	ConsumerRedistributionFraction string `protobuf:"bytes,12,opt,name=consumer_redistribution_fraction,json=consumerRedistributionFraction,proto3" json:"consumer_redistribution_fraction,omitempty"`
	...
	UnbondingPeriod *time.Duration `protobuf:"bytes,14,opt,name=unbonding_period,json=unbondingPeriod,proto3,stdduration" json:"unbonding_period,omitempty"`
}
...
var fileDescriptor_f22ec409a72b7b72 = []byte{
	...
	,
}
