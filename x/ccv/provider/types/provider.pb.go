...
type ConsumerAdditionProposal struct {
	...
	ConnId            string `protobuf:"bytes,15,opt,name=conn_id,json=connId,proto3" json:"conn_id,omitempty"`
	TransferChannelId string `protobuf:"bytes,16,opt,name=transfer_channel_id,json=transferChannelId,proto3" json:"transfer_channel_id,omitempty"`
}
...
var fileDescriptor_f22ec409a72b7b72 = []byte{
	...
	,
}
...
func (m *ConsumerAdditionProposal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ConnId) > 0 {
		...
		i = encodeVarintProvider(dAtA, i, uint64(len(m.ConnId)))
		i--
		dAtA[i] = 0x7a
	}
