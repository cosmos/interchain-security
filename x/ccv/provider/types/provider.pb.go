...
type Params struct {
	...
	// The period for which the slash gas meter is replenished
	SlashMeterReplenishPeriod time.Duration `protobuf:"bytes,5,opt,name=slash_meter_replenish_period,json=slashMeterReplenishPeriod,proto3,stdduration" json:"slash_meter_replenish_period"`
	// The fraction of total voting power that is replenished to the slash gas meter every replenish period.
	// This param also serves as a maximum fraction of total voting power that the slash gas meter can hold.
	SlashGasReplenishFraction string `protobuf:"bytes,6,opt,name=slash_gas_replenish_fraction,json=slashGasReplenishFraction,proto3" json:"slash_gas_replenish_fraction,omitempty"`
	// The maximum amount of pending slash packets that can be queued before the provider chain halts.
	MaxPendingSlashPackets int64 `protobuf:"varint,7,opt,name=max_pending_slash_packets,json=maxPendingSlashPackets,proto3" json:"max_pending_slash_packets,omitempty"`
}
...
func (m *Params) GetSlashGasReplenishFraction() string {
	if m != nil {
		return m.SlashGasReplenishFraction
	}
	return ""
}
...
var fileDescriptor_f22ec409a72b7b72 = []byte{
	...
	,
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.SlashGasReplenishFraction) > 0 {
		i -= len(m.SlashGasReplenishFraction)
		copy(dAtA[i:], m.SlashGasReplenishFraction)
		i = encodeVarintProvider(dAtA, i, uint64(len(m.SlashGasReplenishFraction)))
		i--
		dAtA[i] = 0x32
	}
	n4, err4 := github_com_gogo_protobuf_types.StdDurationMarshalTo(m.SlashMeterReplenishPeriod, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdDuration(m.SlashMeterReplenishPeriod):])
	if err4 != nil {
		return 0, err4
	}
	i -= n4
...
func (m *Params) Size() (n int) {
	...
	n += 1 + l + sovProvider(uint64(l))
	l = len(m.SlashGasReplenishFraction)
	if l > 0 {
		n += 1 + l + sovProvider(uint64(l))
	}
	if m.MaxPendingSlashPackets != 0 {
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SlashGasReplenishFraction", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SlashGasReplenishFraction = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 7:
			if wireType != 0 {
