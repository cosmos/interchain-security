...
type ConsumerAdditionProposal struct {
	...
	// Corresponds to the minimal voting power a validator must have on the provider
	// chain to be able to validate the consumer chain. This is used to prevent
	// validators with very low voting power from validating consumer chains.
	MinValidatorPower uint64 `protobuf:"varint,20,opt,name=min_validator_power,json=minValidatorPower,proto3" json:"min_validator_power,omitempty"`
	// Whether or not to allow inactive validators(=validators on the provider chain that
	// are not part of consensus, but still have stake) to validate the consumer chain.
	AllowInactiveValidators bool `protobuf:"varint,21,opt,name=allow_inactive_validators,json=allowInactiveValidators,proto3" json:"allow_inactive_validators,omitempty"`
}
...
type ConsumerModificationProposal struct {
	...
	// chain to be able to validate the consumer chain. This is used to prevent
	// validators with very low voting power from validating consumer chains.
	MinValidatorPower uint64 `protobuf:"varint,9,opt,name=min_validator_power,json=minValidatorPower,proto3" json:"min_validator_power,omitempty"`
	// Whether or not to allow inactive validators(=validators on the provider chain that
	// are not part of consensus, but still have stake) to validate the consumer chain.
	AllowInactiveValidators bool `protobuf:"varint,10,opt,name=allow_inactive_validators,json=allowInactiveValidators,proto3" json:"allow_inactive_validators,omitempty"`
}
...
func (m *ConsumerModificationProposal) GetMinValidatorPower() uint64 {
	if m != nil {
		return m.MinValidatorPower
	}
	return 0
}

func (m *ConsumerModificationProposal) GetAllowInactiveValidators() bool {
	if m != nil {
		return m.AllowInactiveValidators
	}
	return false
}
...
var fileDescriptor_f22ec409a72b7b72 = []byte{
	...
	,
}
...
func (m *ConsumerAdditionProposal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.MinValidatorPower != 0 {
		i = encodeVarintProvider(dAtA, i, uint64(m.MinValidatorPower))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xa0
...
func (m *ConsumerAdditionProposal) Size() (n int) {
	...
	if m.MinValidatorPower != 0 {
		n += 2 + sovProvider(uint64(m.MinValidatorPower))
	}
	if m.AllowInactiveValidators {
		n += 3
	}
...
func (m *ConsumerModificationProposal) Size() (n int) {
	...
	if m.MinValidatorPower != 0 {
		n += 1 + sovProvider(uint64(m.MinValidatorPower))
	}
	if m.AllowInactiveValidators {
		n += 2
	}
...
func (m *ConsumerAdditionProposal) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 20:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MinValidatorPower", wireType)
			}
			m.MinValidatorPower = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowProvider
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MinValidatorPower |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 21:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field AllowInactiveValidators", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AllowInactiveValidators = bool(v != 0)
		default:
			iNdEx = preIndex
