...
type ConsumerAdditionProposal struct {
	...
	CcvTimeoutPeriod time.Duration `protobuf:"bytes,10,opt,name=ccv_timeout_period,json=ccvTimeoutPeriod,proto3,stdduration" json:"ccv_timeout_period"`
	// Sent transfer related IBC packets will timeout after this duration
	TransferTimeoutPeriod time.Duration `protobuf:"bytes,11,opt,name=transfer_timeout_period,json=transferTimeoutPeriod,proto3,stdduration" json:"transfer_timeout_period"`
	...
	UnbondingPeriod time.Duration `protobuf:"bytes,14,opt,name=unbonding_period,json=unbondingPeriod,proto3,stdduration" json:"unbonding_period"`
}
...
var fileDescriptor_f22ec409a72b7b72 = []byte{
	...
	,
}
