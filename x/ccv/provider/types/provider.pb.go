...
// funds are released if the LockUnbondingOnTimeout parameter is set to false
// for the consumer chain ID.
...
func (m *ConsumerGovernanceProposal) String() string { return proto.CompactTextString(m) }
func (*ConsumerGovernanceProposal) ProtoMessage()    {}
func (*ConsumerGovernanceProposal) Descriptor() ([]byte, []int) {
	return fileDescriptor_f22ec409a72b7b72, []int{5}
}
func (m *ConsumerGovernanceProposal) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ConsumerGovernanceProposal) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ConsumerGovernanceProposal.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ConsumerGovernanceProposal) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ConsumerGovernanceProposal.Merge(m, src)
}
func (m *ConsumerGovernanceProposal) XXX_Size() int {
	return m.Size()
}
func (m *ConsumerGovernanceProposal) XXX_DiscardUnknown() {
	xxx_messageInfo_ConsumerGovernanceProposal.DiscardUnknown(m)
}

var xxx_messageInfo_ConsumerGovernanceProposal proto.InternalMessageInfo

func (m *ConsumerGovernanceProposal) GetConnectionId() string {
	if m != nil {
...
func (m *ConsumerGovernanceProposal) GetContent() *types2.Any {
	if m != nil {
		return m.Content
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*ConsumerGovernanceProposal)(nil), "interchain_security.ccv.provider.v1.ConsumerGovernanceProposal")
}
...
var fileDescriptor_f22ec409a72b7b72 = []byte{
	...
	,
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	n4, err4 := github_com_gogo_protobuf_types.StdDurationMarshalTo(m.CcvTimeoutPeriod, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdDuration(m.CcvTimeoutPeriod):])
	if err4 != nil {
		return 0, err4
	}
	i -= n4
...
func (m *ConsumerGovernanceProposal) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ConsumerGovernanceProposal) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ConsumerGovernanceProposal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ConsumerGovernanceProposal) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ConsumerGovernanceProposal) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ConsumerGovernanceProposal: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ConsumerGovernanceProposal: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
