...
// ConsumerInitializationParameters are the parameters needed to initialize a to be able to launch a chain
...
// PowerShapingParameters contains parameters to modify in the to-be-updated chain
