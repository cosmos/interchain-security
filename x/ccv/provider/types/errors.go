...
var (
	...
	ErrNoUnbondingTime                  = errorsmod.Register(ModuleName, 22, "provider unbonding time not found")
	ErrInvalidAddress                   = errorsmod.Register(ModuleName, 23, "invalid address")
	ErrUnauthorized                     = errorsmod.Register(ModuleName, 24, "unauthorized")
	ErrBlankConsumerChainID             = errorsmod.Register(ModuleName, 25, "consumer chain id must not be blank")
)
