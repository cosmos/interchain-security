...
var (
	...
	ErrInvalidConsumerModificationProposal = errorsmod.Register(ModuleName, 23, "invalid consumer modification proposal")
	ErrNoUnbondingTime                     = errorsmod.Register(ModuleName, 24, "provider unbonding time not found")
	ErrInvalidAddress                      = errorsmod.Register(ModuleName, 25, "invalid address")
	ErrUnauthorized                        = errorsmod.Register(ModuleName, 26, "unauthorized")
	ErrBlankConsumerChainID                = errorsmod.Register(ModuleName, 27, "consumer chain id must not be blank")
)
