...
var (
	...
	ErrNoUnbondingTime                  = errorsmod.Register(ModuleName, 20, "provider unbonding time not found")
	ErrInvalidAddress                   = errorsmod.Register(ModuleName, 21, "invalid address")
	ErrUnauthorized                     = errorsmod.Register(ModuleName, 22, "unauthorized")
	ErrBlankConsumerChainID             = errorsmod.Register(ModuleName, 23, "consumer chain id must not be blank")
)
