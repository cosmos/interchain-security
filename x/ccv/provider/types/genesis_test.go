	...
	testCases := []struct {
		...
		},
		{
			...
			types.NewGenesisState(
				...
				types.NewParams(ibctmtypes.NewClientState("", ibctmtypes.DefaultTrustLevel, 0, 0,
					...
					types.DefaultTrustingPeriodFraction, time.Hour, time.Hour, 30*time.Minute, time.Hour, "0.1", 400, sdk.Coin{Denom: "stake", Amount: sdkmath.NewInt(10000000)}),
				nil,
				nil,
				nil,
				nil,
		...
		},
		{
			...
			types.NewGenesisState(
				...
				types.NewParams(ibctmtypes.NewClientState("", ibctmtypes.DefaultTrustLevel, 0, 0,
					...
					types.DefaultMaxThrottledPackets, sdk.Coin{Denom: "stake", Amount: sdkmath.NewInt(10000000)}),
				nil,
				nil,
				nil,
				nil,
		...
		},
		{
			...
			types.NewGenesisState(
				...
				types.NewParams(ibctmtypes.NewClientState("", ibctmtypes.DefaultTrustLevel, 0, 0,
					...
					types.DefaultSlashMeterReplenishPeriod,
					types.DefaultSlashMeterReplenishFraction,
					types.DefaultMaxThrottledPackets, sdk.Coin{Denom: "stake", Amount: sdkmath.NewInt(1000000)}),
				nil,
				nil,
				nil,
				nil,
		...
		},
		{
			...
			types.NewGenesisState(
				...
				types.NewParams(ibctmtypes.NewClientState("", ibctmtypes.DefaultTrustLevel, 0, 0,
					...
					types.DefaultSlashMeterReplenishPeriod,
					"1.15",
					-1, sdk.Coin{Denom: "stake", Amount: sdkmath.NewInt(10000000)}),
				nil,
				nil,
				nil,
				nil,
		...
		},
		{
			...
			types.NewGenesisState(
				...
				types.NewParams(ibctmtypes.NewClientState("", ibctmtypes.DefaultTrustLevel, 0, 0,
					time.Second*40, clienttypes.Height{}, commitmenttypes.GetSDKSpecs(), []string{"ibc", "upgradedIBCState"}),
					types.DefaultTrustingPeriodFraction, time.Hour, time.Hour, 30*time.Minute, time.Hour, "0.1", 400, sdk.Coin{Denom: "st", Amount: sdkmath.NewInt(10000000)}),
				nil,
				nil,
				nil,
				nil,
		...
		},
		{
			...
			types.NewGenesisState(
				...
				types.NewParams(ibctmtypes.NewClientState("", ibctmtypes.DefaultTrustLevel, 0, 0,
					time.Second*40, clienttypes.Height{}, commitmenttypes.GetSDKSpecs(), []string{"ibc", "upgradedIBCState"}),
					types.DefaultTrustingPeriodFraction, time.Hour, time.Hour, 30*time.Minute, time.Hour, "0.1", 400, sdk.Coin{Denom: "stake", Amount: sdkmath.NewInt(-1000000)}),
				nil,
				nil,
				nil,
				nil,
