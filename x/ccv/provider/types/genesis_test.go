	...
	testCases := []struct {
		...
		},
		{
			...
			types.NewGenesisState(
				...
				types.NewParams(ibctmtypes.NewClientState("", ibctmtypes.DefaultTrustLevel, 0, 0,
					...
					sdk.Coin{Denom: "stake", Amount: sdk.NewInt(10000000)}, 600, 180),
				nil,
				nil,
				nil,
				nil,
		...
		},
		{
			...
			types.NewGenesisState(
				...
				types.NewParams(ibctmtypes.NewClientState("", ibctmtypes.DefaultTrustLevel, 0, 0,
					...
					types.DefaultSlashMeterReplenishPeriod,
					types.DefaultSlashMeterReplenishFraction,
					sdk.Coin{Denom: "stake", Amount: sdk.NewInt(1000000)}, 600, 180),
				nil,
				nil,
				nil,
				nil,
		...
		},
		{
			...
			types.NewGenesisState(
				...
				types.NewParams(ibctmtypes.NewClientState("", ibctmtypes.DefaultTrustLevel, 0, 0,
					time.Second*40, clienttypes.Height{}, commitmenttypes.GetSDKSpecs(), []string{"ibc", "upgradedIBCState"}),
					types.DefaultTrustingPeriodFraction, time.Hour, time.Hour, 30*time.Minute, time.Hour, "0.1", sdk.Coin{Denom: "stake", Amount: sdk.NewInt(-1000000)}, 600, 180),
				nil,
				nil,
				nil,
				nil,
