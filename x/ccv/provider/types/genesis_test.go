...
func TestValidateGenesisState(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			types.NewGenesisState(
				...
				types.NewParams(ibctmtypes.NewClientState("", ibctmtypes.DefaultTrustLevel, 0, 0,
					...
					3, time.Hour, time.Hour, 30*time.Minute, "0.1", 400),
			),
			true,
		},
		{
		...
		{
			"invalid params, invalid slash gas replenish fraction",
			types.NewGenesisState(
				0,
				nil,
				[]types.ConsumerState{{ChainId: "chainid-1", ChannelId: "channelid"}},
				...
				types.NewParams(ibctmtypes.NewClientState("", ibctmtypes.DefaultTrustLevel, 0, 0,
					...
					"0/9", // invalid fraction here
					400),
			),
			false,
		},
		{
			"invalid params, zero max pending slash packets",
			types.NewGenesisState(
				0,
				nil,
				[]types.ConsumerState{{ChainId: "chainid-1", ChannelId: "channelid"}},
				...
				types.NewParams(ibctmtypes.NewClientState("", ibctmtypes.DefaultTrustLevel, 0, 0,
					...
					types.DefaultInitTimeoutPeriod,
					types.DefaultSlashMeterReplenishPeriod,
					types.DefaultSlashGasReplenishFraction,
					0), // 0 max pending slash packets here
			),
			false,
		},
		{
