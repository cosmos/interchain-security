...
type QueryThrottleStateResponse struct {
	...
	NextReplenishCandiate time.Time `protobuf:"bytes,3,opt,name=next_replenish_candiate,json=nextReplenishCandiate,proto3,stdtime" json:"next_replenish_candiate"`
...
func (m *QueryThrottleStateResponse) GetNextReplenishCandiate() time.Time {
	if m != nil {
		return m.NextReplenishCandiate
	}
	return time.Time{}
}
...
var fileDescriptor_422512d7b7586cd7 = []byte{
	...
	,
}
...
func (m *QueryThrottleStateResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	n4, err4 := github_com_gogo_protobuf_types.StdTimeMarshalTo(m.NextReplenishCandiate, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(m.NextReplenishCandiate):])
	if err4 != nil {
		return 0, err4
	}
	i -= n4
...
func (m *QueryThrottleStateResponse) Size() (n int) {
	...
	l = github_com_gogo_protobuf_types.SizeOfStdTime(m.NextReplenishCandiate)
	n += 1 + l + sovQuery(uint64(l))
	if len(m.Packets) > 0 {
...
func (m *QueryThrottleStateResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NextReplenishCandiate", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := github_com_gogo_protobuf_types.StdTimeUnmarshal(&m.NextReplenishCandiate, dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
