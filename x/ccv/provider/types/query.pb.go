...
type QueryProposedChainIDsResponse struct {
	ProposedChainIDs []string `protobuf:"bytes,1,rep,name=proposedChainIDs,proto3" json:"proposedChainIDs,omitempty"`
}
...
func (m *QueryProposedChainIDsResponse) GetProposedChainIDs() []string {
	if m != nil {
		return m.ProposedChainIDs
	}
	return nil
}
...
var fileDescriptor_422512d7b7586cd7 = []byte{
	...
	,
}
...
type QueryClient interface {
	...
	// before voting period finishes, after voting period finish, this chainID will be removed from the result
...
func (m *QueryProposedChainIDsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.ProposedChainIDs) > 0 {
		for iNdEx := len(m.ProposedChainIDs) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.ProposedChainIDs[iNdEx])
			copy(dAtA[i:], m.ProposedChainIDs[iNdEx])
			i = encodeVarintQuery(dAtA, i, uint64(len(m.ProposedChainIDs[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *QueryProposedChainIDsResponse) Size() (n int) {
	...
	_ = l
	if len(m.ProposedChainIDs) > 0 {
		for _, s := range m.ProposedChainIDs {
			l = len(s)
			n += 1 + l + sovQuery(uint64(l))
		}
	}
...
func (m *QueryProposedChainIDsResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ProposedChainIDs", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ProposedChainIDs = append(m.ProposedChainIDs, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipQuery(dAtA[iNdEx:])
