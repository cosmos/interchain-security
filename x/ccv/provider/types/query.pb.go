...
type QueryConsumerValidatorsValidator struct {
	...
	ConsumerPower int64 `protobuf:"varint,4,opt,name=consumer_power,json=consumerPower,proto3" json:"consumer_power,omitempty"`
	// The rate to charge delegators on the consumer chain, as a fraction
	ConsumerCommissionRate cosmossdk_io_math.LegacyDec `protobuf:"bytes,5,opt,name=consumer_commission_rate,json=consumerCommissionRate,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"consumer_commission_rate"`
	// The rate to charge delegators on the provider chain, as a fraction
	ProviderCommissionRate cosmossdk_io_math.LegacyDec `protobuf:"bytes,6,opt,name=provider_commission_rate,json=providerCommissionRate,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"provider_commission_rate"`
	...
	Status types1.BondStatus `protobuf:"varint,10,opt,name=status,proto3,enum=cosmos.staking.v1beta1.BondStatus" json:"status,omitempty"`
	// provider_tokens defines the delegated tokens (incl. self-delegation).
	ProviderTokens cosmossdk_io_math.Int `protobuf:"bytes,11,opt,name=provider_tokens,json=providerTokens,proto3,customtype=cosmossdk.io/math.Int" json:"provider_tokens"`
	// The power of the validator used on the provider chain
	ProviderPower int64 `protobuf:"varint,12,opt,name=provider_power,json=providerPower,proto3" json:"provider_power,omitempty"`
	// validates_current_epoch defines whether the validator has to validate for the current epoch or not
	ValidatesCurrentEpoch bool `protobuf:"varint,13,opt,name=validates_current_epoch,json=validatesCurrentEpoch,proto3" json:"validates_current_epoch,omitempty"`
}
...
var fileDescriptor_422512d7b7586cd7 = []byte{
	...
	,
}
