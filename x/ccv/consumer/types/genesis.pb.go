...
type GenesisState struct {
	...
	// Address of the provider's governance module
	ProviderGovernanceAddress string `protobuf:"bytes,12,opt,name=provider_governance_address,json=providerGovernanceAddress,proto3" json:"provider_governance_address,omitempty"`
}
...
func (m *GenesisState) GetProviderGovernanceAddress() string {
	if m != nil {
		return m.ProviderGovernanceAddress
	}
	return ""
}
...
var fileDescriptor_2db73a6057a27482 = []byte{
	...
	,
}
...
func (m *GenesisState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.ProviderGovernanceAddress) > 0 {
		i -= len(m.ProviderGovernanceAddress)
		copy(dAtA[i:], m.ProviderGovernanceAddress)
		i = encodeVarintGenesis(dAtA, i, uint64(len(m.ProviderGovernanceAddress)))
		i--
		dAtA[i] = 0x62
	}
	{
...
func (m *GenesisState) Size() (n int) {
	...
	n += 1 + l + sovGenesis(uint64(l))
	l = len(m.ProviderGovernanceAddress)
	if l > 0 {
		n += 1 + l + sovGenesis(uint64(l))
	}
	return n
...
func (m *GenesisState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 12:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ProviderGovernanceAddress", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ProviderGovernanceAddress = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
