...
type GenesisState struct {
	...
	// PendingDataPackets nil on new chain, filled in on restart.
	PendingDataPackets DataPackets `protobuf:"bytes,11,opt,name=pending_data_packets,json=pendingDataPackets,proto3" json:"pending_data_packets"`
...
func (m *GenesisState) GetPendingDataPackets() DataPackets {
	if m != nil {
		return m.PendingDataPackets
	}
	return DataPackets{}
}
...
var fileDescriptor_2db73a6057a27482 = []byte{
	...
	,
}
...
func (m *GenesisState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x62
	{
		size, err := m.PendingDataPackets.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *GenesisState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PendingDataPackets", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.PendingDataPackets.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 12:
