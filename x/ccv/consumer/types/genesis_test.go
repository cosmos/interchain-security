...
func TestValidateRestartGenesisState(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			types.NewRestartGenesisState("ccvclient", "ccvchannel", nil, valUpdates, nil, types.DataPackets{}, nil, types.LastTransmissionBlockHeight{}, params),
			false,
		},
		{
			...
			}, valUpdates, nil, types.DataPackets{}, nil, types.LastTransmissionBlockHeight{}, params),
			false,
		},
		{
			"invalid restart consumer genesis state: channel id is empty",
			types.NewRestartGenesisState("", "ccvchannel", nil, valUpdates, nil, types.DataPackets{}, nil, types.LastTransmissionBlockHeight{}, params),
			true,
		},
		{
		...
		},
		{
			...
			types.NewRestartGenesisState("ccvclient", "ccvchannel", nil, nil, nil, types.DataPackets{}, nil, types.LastTransmissionBlockHeight{}, params),
			true,
		},
		{
			"invalid restart consumer genesis state: invalid params",
			types.NewRestartGenesisState("ccvclient", "ccvchannel", nil, valUpdates, nil, types.DataPackets{}, nil, types.LastTransmissionBlockHeight{},
				types.NewParams(
					true,
					types.DefaultBlocksPerDistributionTransmission,
					"",
