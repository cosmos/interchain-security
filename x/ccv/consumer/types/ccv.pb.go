...
// NOTE: type copied from ccv/provider/v1/provider.proto
// this should only be temporary until we have a better way to share types
...
func (*HandshakeMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_6e322c0e5242c0c0, []int{7}
}
...
var fileDescriptor_6e322c0e5242c0c0 = []byte{
	...
	,
}
...
func (m *HandshakeMetadata) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Version) > 0 {
		...
		i = encodeVarintCcv(dAtA, i, uint64(len(m.Version)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.ProviderFeePoolAddr) > 0 {
		...
		i = encodeVarintCcv(dAtA, i, uint64(len(m.ProviderFeePoolAddr)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
