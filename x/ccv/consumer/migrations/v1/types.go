...
type SlashRequest struct {
	Packet     *ccvtypes.SlashPacketData   `protobuf:"bytes,1,opt,name=packet,proto3" json:"packet,omitempty"`
	Infraction stakingtypes.InfractionType `protobuf:"varint,2,opt,name=infraction,proto3,enum=cosmos.staking.v1beta1.InfractionType" json:"infraction,omitempty"`
}
...
func (m *SlashRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Packet == nil {
				m.Packet = &ccvtypes.SlashPacketData{}
			}
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Infraction |= stakingtypes.InfractionType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
