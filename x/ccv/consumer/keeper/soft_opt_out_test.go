...
func TestUpdateSmallestNonOptOutPower(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			optOutThresh: "0.05",
			validators: []*cmttypes.Validator{
				cmttypes.NewValidator(cIds[0].TMCryptoPubKey(), 1),
				cmttypes.NewValidator(cIds[1].TMCryptoPubKey(), 1),
				cmttypes.NewValidator(cIds[2].TMCryptoPubKey(), 1),
				cmttypes.NewValidator(cIds[3].TMCryptoPubKey(), 3),
				cmttypes.NewValidator(cIds[4].TMCryptoPubKey(), 49),
				cmttypes.NewValidator(cIds[5].TMCryptoPubKey(), 51),
			},
		...
		},
		{
			...
			optOutThresh: "0.05",
			validators: []*cmttypes.Validator{
				cmttypes.NewValidator(cIds[0].TMCryptoPubKey(), 3),
				cmttypes.NewValidator(cIds[1].TMCryptoPubKey(), 51),
				cmttypes.NewValidator(cIds[2].TMCryptoPubKey(), 1),
				cmttypes.NewValidator(cIds[3].TMCryptoPubKey(), 49),
				cmttypes.NewValidator(cIds[4].TMCryptoPubKey(), 1),
				cmttypes.NewValidator(cIds[5].TMCryptoPubKey(), 1),
			},
		...
		},
		{
			...
			validators: []*cmttypes.Validator{
				...
				cmttypes.NewValidator(cIds[2].TMCryptoPubKey(), 1),
				cmttypes.NewValidator(cIds[3].TMCryptoPubKey(), 3),
				cmttypes.NewValidator(cIds[4].TMCryptoPubKey(), 500),
			},
		...
		},
		{
			...
			validators: []*cmttypes.Validator{
				cmttypes.NewValidator(cIds[0].TMCryptoPubKey(), 54),
				cmttypes.NewValidator(cIds[1].TMCryptoPubKey(), 53),
				cmttypes.NewValidator(cIds[2].TMCryptoPubKey(), 52),
				cmttypes.NewValidator(cIds[3].TMCryptoPubKey(), 51),
				cmttypes.NewValidator(cIds[4].TMCryptoPubKey(), 50),
				cmttypes.NewValidator(cIds[5].TMCryptoPubKey(), 1),
				cmttypes.NewValidator(cIds[6].TMCryptoPubKey(), 1),
			},
