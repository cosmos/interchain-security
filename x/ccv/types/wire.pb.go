...
type ValidatorSetChangePacketData struct {
	ValidatorUpdates []v2.ValidatorUpdate `protobuf:"bytes,1,rep,name=validator_updates,json=validatorUpdates,proto3" json:"validator_updates" yaml:"validator_updates"`
...
func (m *ValidatorSetChangePacketData) GetValidatorUpdates() []v2.ValidatorUpdate {
	if m != nil {
...
type SlashPacketData struct {
	Validator v2.Validator `protobuf:"bytes,1,opt,name=validator,proto3" json:"validator" yaml:"validator"`
	// map to the infraction block height on the provider
	ValsetUpdateId uint64 `protobuf:"varint,2,opt,name=valset_update_id,json=valsetUpdateId,proto3" json:"valset_update_id,omitempty"`
	// tell if the slashing is for a downtime or a double-signing infraction
	Infraction types.Infraction `protobuf:"varint,3,opt,name=infraction,proto3,enum=cosmos.staking.v1beta1.Infraction" json:"infraction,omitempty"`
}
...
func (m *SlashPacketData) GetValidator() v2.Validator {
	if m != nil {
		return m.Validator
	}
	return v2.Validator{}
...
func (m *SlashPacketData) GetInfraction() types.Infraction {
	if m != nil {
		return m.Infraction
	}
	return types.Infraction_INFRACTION_UNSPECIFIED
}
...
func (m *SlashPacketDataV1) GetValidator() v2.Validator {
	if m != nil {
		return m.Validator
	}
	return v2.Validator{}
...
var fileDescriptor_8fd0dc67df6b10ed = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Infraction |= types.Infraction(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
