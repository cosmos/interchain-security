...
**interchain-security** houses the code for implementing Interchain Security: <https://blog.cosmos.network/interchain-security-is-coming-to-the-cosmos-hub-f144c45fb035>. The repo is currently a WIP and targets v1 of Interchain Security.
