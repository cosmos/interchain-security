...
| :warning: This branch includes a full model of slashing which may be useful for testing system properties but it not great for generating tests to run against the real system. This is because of the divergence caused by sdk.Dec numerical precision. :warning:
| --- |
