...
import (
	...
	sovereignApp "github.com/cosmos/interchain-security/v7/app/sovereign"
)
...
func NewRootCmd() *cobra.Command {
	...
	initClientCtx := client.Context{}.
		...
		WithHomeDir(sovereignApp.DefaultNodeHome).
...
func initRootCmd(rootCmd *cobra.Command, encodingConfig appencoding.EncodingConfig) {
	...
	rootCmd.AddCommand(
		genutilcli.InitCmd(sovereignApp.ModuleBasics, sovereignApp.DefaultNodeHome),
		debug.Cmd(),
		pruning.Cmd(newApp, sovereignApp.DefaultNodeHome),
		confixcmd.ConfigCommand(),
	)

	server.AddCommands(rootCmd, sovereignApp.DefaultNodeHome, newApp, appExport, addModuleInitFlags)
