...
func (a appCreator) appExport(
	...
	if height != -1 {
		simApp = simapp.New(logger, db, traceStore, false, map[int64]bool{}, homePath, uint(1), appOpts)

		if err := simApp.LoadHeight(height); err != nil {
			return servertypes.ExportedApp{}, err
		}
	} else {
		simApp = simapp.New(logger, db, traceStore, true, map[int64]bool{}, homePath, uint(1), appOpts)
	}
