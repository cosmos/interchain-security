...
func initRootCmd(
	...
	rootCmd.AddCommand(
		genutilcli.InitCmd(basicManager, providerApp.DefaultNodeHome),
		debug.Cmd(),
...
func genesisCommand(txConfig client.TxConfig, basicManager module.BasicManager, cmds ...*cobra.Command) *cobra.Command {
	cmd := genutilcli.Commands(txConfig, basicManager, providerApp.DefaultNodeHome)
