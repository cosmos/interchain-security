...
// stepsStartChains starts provider and consumer chains and performs basic sanity checks.
// Use this step as the first phase of all test scenarios.
func stepsStartChains(consumerName string) []Step {
	return []Step{
		{
