...
func delegate(s *CCVTestSuite, delAddr sdk.AccAddress, bondAmt math.Int) (initBalance math.Int, shares sdkmath.LegacyDec, valAddr sdk.ValAddress) {
...
func delegateByIdx(s *CCVTestSuite, delAddr sdk.AccAddress, bondAmt math.Int, idx int) (initBalance math.Int, shares sdkmath.LegacyDec, valAddr sdk.ValAddress) {
...
func undelegate(s *CCVTestSuite, delAddr sdk.AccAddress, valAddr sdk.ValAddress, sharesAmount sdkmath.LegacyDec) (valsetUpdateId uint64) {
...
func redelegate(s *CCVTestSuite, delAddr sdk.AccAddress, valSrcAddr sdk.ValAddress,
	valDstAddr sdk.ValAddress, sharesAmount sdkmath.LegacyDec,
) {
...
func (s *CCVTestSuite) setupValidatorPowers() {
	...
	for idx := range s.providerChain.Vals.Validators {
		delegateByIdx(s, delAddr, sdkmath.NewInt(999999999), idx)
	}
