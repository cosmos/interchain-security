...
func (suite *ProviderTestSuite) SetupTest() {
	...
	icahostkeeper.InitGenesis(suite.consumerChain.GetContext(),
		suite.consumerChain.App.(*appConsumer.App).ICAHostKeeper, hostICAGenesis)
...
func (suite *ProviderTestSuite) SetupCCVChannel() {
	...
	suite.SetupGovernanceICAChannel()
}
...
func (suite *ProviderTestSuite) SetupGovernanceICAChannel() {
