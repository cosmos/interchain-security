...
// source: interchain_security/ccv/consumer/v2/consumer.proto
...
func (*Params) Descriptor() ([]byte, []int) {
	return fileDescriptor_154285f600605b15, []int{0}
}
...
func (*LastTransmissionBlockHeight) Descriptor() ([]byte, []int) {
	return fileDescriptor_154285f600605b15, []int{1}
}
...
func (*CrossChainValidator) Descriptor() ([]byte, []int) {
	return fileDescriptor_154285f600605b15, []int{2}
}
...
func (*MaturingVSCPacket) Descriptor() ([]byte, []int) {
	return fileDescriptor_154285f600605b15, []int{3}
}
...
func init() {
	proto.RegisterType((*Params)(nil), "interchain_security.ccv.consumer.v2.Params")
	proto.RegisterType((*LastTransmissionBlockHeight)(nil), "interchain_security.ccv.consumer.v2.LastTransmissionBlockHeight")
	proto.RegisterType((*CrossChainValidator)(nil), "interchain_security.ccv.consumer.v2.CrossChainValidator")
	proto.RegisterType((*MaturingVSCPacket)(nil), "interchain_security.ccv.consumer.v2.MaturingVSCPacket")
}

func init() {
	proto.RegisterFile("interchain_security/ccv/consumer/v2/consumer.proto", fileDescriptor_154285f600605b15)
}

var fileDescriptor_154285f600605b15 = []byte{
	...
	0x7c, 0x89, 0x04, 0x38, 0xdb, 0xa5, 0xc0, 0x0e, 0xb5, 0xb3, 0xa2, 0xdd, 0xbf, 0x78, 0xaa, 0xd1,
	...
	,
}
