...
func (m *MockStakingKeeper) GetLastTotalPower(ctx types0.Context) types0.Int {
	m.ctrl.T.Helper()
...
func (m *MockStakingKeeper) PowerReduction(ctx types0.Context) types0.Int {
	m.ctrl.T.Helper()
...
func (m *MockStakingKeeper) Slash(ctx types0.Context, consAddr types0.ConsAddress, infractionHeight, power int64, slashFactor math.LegacyDec) math.Int {
	m.ctrl.T.Helper()
...
func (m *MockConsumerHooks) AfterValidatorBonded(ctx types0.Context, consAddr types0.ConsAddress, arg2 types0.ValAddress) {
	m.ctrl.T.Helper()
...
func (m *MockIBCTransferKeeper) SendTransfer(ctx types0.Context, sourcePort, sourceChannel string, token types0.Coin, sender types0.AccAddress, receiver string, timeoutHeight types6.Height, timeoutTimestamp uint64) error {
	m.ctrl.T.Helper()
