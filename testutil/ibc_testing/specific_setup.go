...
func ProviderAppIniter() (ibctesting.App, map[string]json.RawMessage) {
	...
	testApp := appProvider.New(log.NewNopLogger(), tmdb.NewMemDB(), nil, true, map[int64]bool{},
		simapp.DefaultNodeHome, 5, encoding, simapp.EmptyAppOptions{}).(ibctesting.App)
...
func ConsumerAppIniter() (ibctesting.App, map[string]json.RawMessage) {
...
func DemocracyConsumerAppIniter() (ibctesting.App, map[string]json.RawMessage) {
