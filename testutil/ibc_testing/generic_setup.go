...
func AddProvider[T intgutil.ProviderApp](coordinator *ibctesting.Coordinator, t *testing.T, appIniter ibctesting.AppIniter) (
...
func AddDemocracyConsumer[T intgutil.DemocConsumerApp](coordinator *ibctesting.Coordinator, t *testing.T,
...
func AddConsumer[Tp intgutil.ProviderApp, Tc intgutil.ConsumerApp](
